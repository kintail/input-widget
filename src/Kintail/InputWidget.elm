...
See the [Embedding.elm](https://github.com/kintail/input-widget/blob/1.0.4/examples/Embedding.elm)
...
See the [RadioButton.elm](https://github.com/kintail/input-widget/blob/1.0.4/examples/RadioButton.elm)
example for sample usage.
-}
...
See the [Validation.elm](https://github.com/kintail/input-widget/blob/1.0.4/examples/Validation.elm)
example for sample usage.
-}
...
See the [ComboBox.elm](https://github.com/kintail/input-widget/blob/1.0.4/examples/ComboBox.elm)
example for sample usage.
-}
...
See the [Slider.elm](https://github.com/kintail/input-widget/blob/1.0.4/examples/Slider.elm)
example for sample usage.
-}
slider :
...
See the [Custom.elm](https://github.com/kintail/input-widget/blob/1.0.4/examples/Custom.elm)
example for sample usage.
-}
